package mihee.com.baeldung.monitoring.service;

import mihee.com.baeldung.monitoring.util.MonitoringUtil;
...
public class LagAnalyzerService {
    ...
    public Map<TopicPartition, Long> getConsumerGrpOffsets (String groupId) throws ExecutionException, InterruptedException {
        ...
        Map<TopicPartition, OffsetAndMetadata> mestadataMap = info.partitionsToOffsetAndMetadata().get();
        Map<TopicPartition, Long> groupOffset = new HashMap<>();
        for (Map.Entry<TopicPartition, OffsetAndMetadata> entry : mestadataMap.entrySet()) {
    ...
    private KafkaConsumer<String, String> getKafkaConsumer(String bootstrapServerConfig) {
        ...
        properties.setProperty(
                ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, bootstrapServerConfig
        );
        properties.setProperty(
